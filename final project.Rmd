...
## Methodology
Code and data is available at:  "https://github.com/Feymann7/STA304-final-project"
\
...
```{r, echo=FALSE}
model3<-lm(feelings_life ~age_at_first_birth  +sex+
        marital_status+education+income_family+self_rated_health+self_rated_mental_health+
...
```
\
Age is deleted from the linear model. Model 3 is the final model
